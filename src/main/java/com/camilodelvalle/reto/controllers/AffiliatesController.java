...
public class AffiliatesController {
	...
	public ResponseEntity<?> getById(@PathVariable int id) {
		List<Affiliates> affiliatesConsultadosUsuario = this.affiliatesServiceImpl.getById();
	...
	public ResponseEntity<?> put(@RequestBody Affiliates affiliates) {
		Affiliates affiliatesActualizado = this.affiliatesServiceImpl.put(affiliates);
